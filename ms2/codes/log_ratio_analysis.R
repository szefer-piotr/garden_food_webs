# Log ratio analysis comparisons
...
abu_ratio <- abu_ratio %>%
  ...
  mutate(lratioPl = log(numpl/denpl))

ggplot(abu_ratio,aes(x=ratio,y=lratioPl))+
  geom_point()+
  geom_smooth(method = "lm")+
  xlab("IAP to Herbivore Ratio")+
  ylab("Predator indirect effect on plants")
